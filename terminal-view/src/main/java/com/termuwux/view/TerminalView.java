...
public final class TerminalView extends View {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (props.getProperty("enforce-char-based-input", "false").equals("true")) {
            ...
            // https://github.com/termuwux/termuwux-app/issues/686
            outAttrs.inputType = InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS;
        } else {
            // Using InputType.NULL is the most correct input type and avoids issues with other hacks.
            //
            // Previous keyboard issues:
            // https://github.com/termuwux/termuwux-packages/issues/25
            // https://github.com/termuwux/termuwux-app/issues/87.
            // https://github.com/termuwux/termuwux-app/issues/126.
            // https://github.com/termuwux/termuwux-app/issues/137 (japanese chars and TYPE_NULL).
            outAttrs.inputType = InputType.TYPE_NULL;
        }

        // Note that IME_ACTION_NONE cannot be used as that makes it impossible to input newlines using the on-screen
        // keyboard on Android TV (see https://github.com/termuwux/termuwux-app/issues/221).
    ...
    private Properties getProperties() {
        ...
        String possiblePropLocations[] = {
            getContext().getFilesDir() + "/home/.termuwux/termuwux.properties",
            getContext().getFilesDir() + "/home/.config/termuwux/termuwux.properties"
        };
