...
public class termuwuxFileReceiverActivityTest {
    ...
    public void testIsSharedTextAnUrl() {
        ...
        for (String url : validUrls) {
            Assert.assertTrue(termuwuxFileReceiverActivity.isSharedTextAnUrl(url));
        }

        List<String> invalidUrls = new ArrayList<>();
        invalidUrls.add("a test with example.com");
        for (String url : invalidUrls) {
            Assert.assertFalse(termuwuxFileReceiverActivity.isSharedTextAnUrl(url));
        }
    }
