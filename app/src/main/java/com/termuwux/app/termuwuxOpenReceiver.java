...
public class termuwuxOpenReceiver extends BroadcastReceiver {

    @Override
    public void onReceive(Context context, Intent intent) {
        final Uri data = intent.getData();
        if (data == null) {
            Log.e(EmulatorDebug.LOG_TAG, "termuwux-open: Called without intent data");
            return;
        }
        ...
        if (isExternalUrl) {
            ...
            try {
                ...
                Log.e(EmulatorDebug.LOG_TAG, "termuwux-open: No app handles the url " + data);
            }
            return;
        }
        ...
        if (!(fileToShare.isFile() && fileToShare.canRead())) {
            Log.e(EmulatorDebug.LOG_TAG, "termuwux-open: Not a readable file: '" + fileToShare.getAbsolutePath() + "'");
            return;
        }
        ...
        Uri uriToShare = Uri.parse("content://com.termuwux.files" + fileToShare.getAbsolutePath());
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                if (!(path.startsWith(termuwuxService.FILES_PATH) || path.startsWith(storagePath))) {
