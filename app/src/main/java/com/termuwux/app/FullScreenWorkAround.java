...
/**
 * Work around for fullscreen mode in termuwux to fix ExtraKeysView not being visible.
...
public class FullScreenWorkAround {
    ...
    public static void apply(termuwuxActivity activity) {
        new FullScreenWorkAround(activity);
    }

    private FullScreenWorkAround(termuwuxActivity activity) {
