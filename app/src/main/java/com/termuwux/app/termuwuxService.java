 ...
 * running so that it is not terminated. The user interacts with the session through {@link termuwuxActivity}, but this
 * service may outlive the activity when the user or the system disposes of the activity. In that case the user may
 * restart {@link termuwuxActivity} later to yet again access the sessions.
 * <p/>
 ...
 */
public final class termuwuxService extends Service implements SessionChangedCallback {

    private static final String NOTIFICATION_CHANNEL_ID = "termuwux_notification_channel";

    /** Note that this is a symlink on the Android M preview. */
    @SuppressLint("SdCardPath")
    public static final String FILES_PATH = "/data/data/com.termuwux/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "com.termuwux.service_stop";
    private static final String ACTION_LOCK_WAKE = "com.termuwux.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "com.termuwux.service_wake_unlock";
    /** Intent action to launch a new terminal session. Executed from termuwuxWidgetProvider. */
    public static final String ACTION_EXECUTE = "com.termuwux.service_execute";

    public static final String EXTRA_ARGUMENTS = "com.termuwux.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "com.termuwux.execute.cwd";
    public static final String EXTRA_EXECUTE_IN_BACKGROUND = "com.termuwux.execute.background";

    /** This service is only bound from inside the same process and never uses IPC. */
    class LocalBinder extends Binder {
        public final termuwuxService service = termuwuxService.this;
    }
     ...
     * <p/>
     * Note that this list is observed by {@link termuwuxActivity#mListViewAdapter}, so any changes must be made on the UI
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_STOP_SERVICE.equals(action)) {
            ...
            if (intent.getBooleanExtra(EXTRA_EXECUTE_IN_BACKGROUND, false)) {
                ...
                boolean failsafe = intent.getBooleanExtra(termuwuxActivity.termuwux_FAILSAFE_SESSION_ACTION, false);
                ...
                termuwuxPreferences.storeCurrentSession(this, newSession);

                // Launch the main termuwux app, which will now show the current session:
                startActivity(new Intent(this, termuwuxActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        } else if (action != null) {
            Log.e(EmulatorDebug.LOG_TAG, "Unknown termuwuxService action: '" + action + "'");
        }
    ...
    private Notification buildNotification() {
        Intent notifyIntent = new Intent(this, termuwuxActivity.class);
        ...
        Intent exitIntent = new Intent(this, termuwuxService.class).setAction(ACTION_STOP_SERVICE);
        builder.addAction(android.R.drawable.ic_delete, res.getString(R.string.notification_action_exit), PendingIntent.getService(this, 0, exitIntent, 0));

        String newWakeAction = wakeLockHeld ? ACTION_UNLOCK_WAKE : ACTION_LOCK_WAKE;
        Intent toggleWakeLockIntent = new Intent(this, termuwuxService.class).setAction(newWakeAction);
    ...
    public void onDestroy() {
        File termuwuxTmpDir = new File(termuwuxService.PREFIX_PATH + "/tmp");

        if (termuwuxTmpDir.exists()) {
            try {
                termuwuxInstaller.deleteFolder(termuwuxTmpDir.getCanonicalFile());
            } catch (Exception e) {
                Log.e(EmulatorDebug.LOG_TAG, "Error while removing file at " + termuwuxTmpDir.getAbsolutePath(), e);
            }

            termuwuxTmpDir.mkdirs();
        }
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        Intent stylingIntent = new Intent("com.termuwux.app.reload_style");
        stylingIntent.putExtra("com.termuwux.app.reload_style", "styling");
    ...
    private void setupNotificationChannel() {
        ...
        String channelName = "termuwux";
        String channelDescription = "Notifications from termuwux";
