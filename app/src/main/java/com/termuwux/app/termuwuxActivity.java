...
import com.termuwux.R;
import com.termuwux.terminal.EmulatorDebug;
import com.termuwux.terminal.TerminalColors;
import com.termuwux.terminal.TerminalSession;
import com.termuwux.terminal.TerminalSession.SessionChangedCallback;
import com.termuwux.terminal.TextStyle;
import com.termuwux.view.TerminalView;
 ...
 * about memory leaks.
 */
public final class termuwuxActivity extends Activity implements ServiceConnection {

    public static final String termuwux_FAILSAFE_SESSION_ACTION = "com.termuwux.app.failsafe_session";
    ...
    private static final String RELOAD_STYLE_ACTION = "com.termuwux.app.reload_style";

    private static final String BROADCAST_termuwux_OPENED = "com.termuwux.app.OPENED";
    ...
    termuwuxPreferences mSettings;

    /**
     * The connection to the {@link termuwuxService}. Requested in {@link #onCreate(Bundle)} with a call to
     * {@link #bindService(Intent, ServiceConnection, int)}, and obtained and stored in
     * {@link #onServiceConnected(ComponentName, IBinder)}.
     */
    termuwuxService mTermService;
            ...
            if (mIsVisible) {
                ...
                if ("storage".equals(whatToReload)) {
                    if (ensureStoragePermissionGranted())
                        termuwuxInstaller.setupStorageSymlinks(termuwuxActivity.this);
                    return;
                }
                checkForFontAndColors();
                mSettings.reloadFromProperties(termuwuxActivity.this);
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/com.termuwux/files/home/.termuwux/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/com.termuwux/files/home/.termuwux/colors.properties");
    ...
    public void onCreate(Bundle bundle) {
        mSettings = new termuwuxPreferences(this);
        mIsUsingBlackUI = mSettings.isUsingBlackUI();
        if (mIsUsingBlackUI) {
            this.setTheme(R.style.Theme_termuwux_Black);
        } else {
            this.setTheme(R.style.Theme_termuwux);
        }
        ...
        mTerminalView.setOnKeyListener(new termuwuxViewClient(this));
        ...
        viewPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(@NonNull ViewGroup collection, int position) {
                LayoutInflater inflater = LayoutInflater.from(termuwuxActivity.this);
                View layout;
                if (position == 0) {
                    ...
                    if (mSettings.isUsingFullScreen() && mSettings.isUsingFullScreenWorkAround()) {
                        FullScreenWorkAround.apply(termuwuxActivity.this);
                    }
        ...
        newSessionButton.setOnLongClickListener(v -> {
            DialogUtils.textInput(termuwuxActivity.this, R.string.session_new_named_title, null, R.string.session_new_named_positive_button,
        ...
        Intent serviceIntent = new Intent(this, termuwuxService.class);
    ...
    /**
     * Send a broadcast notifying termuwux app has been opened
     */
    void sendOpenedBroadcast() {
        Intent broadcast = new Intent(BROADCAST_termuwux_OPENED);
        List<ResolveInfo> matches = getPackageManager().queryBroadcastReceivers(broadcast, 0);

        // send broadcast to registered termuwux receivers
    ...
    void toggleShowExtraKeys() {
        final ViewPager viewPager = findViewById(R.id.viewpager);
        final boolean showNow = mSettings.toggleShowExtraKeys(termuwuxActivity.this);
    ...
    public void onServiceConnected(ComponentName componentName, IBinder service) {
        mTermService = ((termuwuxService.LocalBinder) service).service;
        ...
        mTermService.mSessionChangeCallback = new SessionChangedCallback() {
            ...
            public void onBell(TerminalSession session) {
                ...
                switch (mSettings.mBellBehaviour) {
                    case termuwuxPreferences.BELL_BEEP:
                        mBellSoundPool.play(mBellSoundId, 1.f, 1.f, 1, 0, 1.f);
                        break;
                    case termuwuxPreferences.BELL_VIBRATE:
                        BellUtil.getInstance(termuwuxActivity.this).doBell();
                        break;
                    case termuwuxPreferences.BELL_IGNORE:
        ...
        if (false && mTermService.getSessions().isEmpty()) {
            if (mIsVisible) {
                termuwuxInstaller.setupIfNeeded(termuwuxActivity.this, () -> {
                    if (mTermService == null) return; // Activity might have been destroyed.
                    try {
                        Bundle bundle = getIntent().getExtras();
                        boolean launchFailsafe = false;
                        if (bundle != null) {
                            launchFailsafe = bundle.getBoolean(termuwux_FAILSAFE_SESSION_ACTION, false);
                        }
            ...
            //if (i != null && Intent.ACTION_RUN.equals(i.getAction())) {
              ...
              //  boolean failSafe = i.getBooleanExtra(termuwux_FAILSAFE_SESSION_ACTION, false);
    ...
    public void onServiceDisconnected(ComponentName name) {
        // Respect being stopped from the termuwuxService notification action.
        finish();
    }
    ...
    protected void onStop() {
        ...
        mIsVisible = false;
        TerminalSession currentSession = getCurrentTermSession();
        if (currentSession != null) termuwuxPreferences.storeCurrentSession(this, currentSession);
    ...
    void showUrlSelection() {
        ...
        final AlertDialog dialog = new AlertDialog.Builder(termuwuxActivity.this).setItems(urls, (di, which) -> {
            String url = (String) urls[which];
            ClipboardManager clipboard = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
            clipboard.setPrimaryClip(new ClipData(null, new String[]{"text/plain"}, new ClipData.Item(url)));
            Toast.makeText(termuwuxActivity.this, R.string.select_url_copied_to_clipboard, Toast.LENGTH_LONG).show();
        ...
        switch (item.getItemId()) {
            ...
            case CONTEXTMENU_SHARE_TRANSCRIPT_ID:
                if (session != null) {
                    ...
                    // See https://github.com/termuwux/termuwux-app/issues/1166.
            ...
            case CONTEXTMENU_STYLING_ID: {
                ...
                stylingIntent.setClassName("com.termuwux.styling", "com.termuwux.styling.termuwuxStyleActivity");
                try {
                    ...
                    new AlertDialog.Builder(this).setMessage(R.string.styling_not_installed)
                        .setPositiveButton(R.string.styling_install, (dialog, which) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://f-droid.org/en/packages/com.termuwux.styling/")))).setNegativeButton(android.R.string.cancel, null).show();
                }
                return true;
            }
            case CONTEXTMENU_HELP_ID:
                startActivity(new Intent(this, termuwuxHelpActivity.class));
                return true;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        if (requestCode == REQUESTCODE_PERMISSION_STORAGE && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            termuwuxInstaller.setupStorageSymlinks(this);
        }
    }
    ...
    public TerminalSession getStoredCurrentSessionOrLast() {
        TerminalSession stored = termuwuxPreferences.getCurrentSession(this);
    ...
    void showToast(String text, boolean longDuration) {
        ...
        mLastToast = Toast.makeText(termuwuxActivity.this, text, longDuration ? Toast.LENGTH_LONG : Toast.LENGTH_SHORT);
    ...
    public void removeFinishedSession(TerminalSession finishedSession) {
        ...
        termuwuxService service = mTermService;
